  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
        "bg-neutral-900 text-neutral-50 hover:bg-neutral-900 hover:text-neutral-50  focus:text-neutral-50 dark:bg-neutral-800 dark:text-neutral-50 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 ",
        day_today: "bg-neutral-100 text-neutral-900 dark:bg-neutral-200 dark:text-neutral-900",
        day_outside:
